...
mysql_select_db("db_soal");
    echo "<h3>Latihan Soal IPA Paket 2</h3>
    <b>Selamat Mengerjakan</b>";
echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:700px;'>";
 echo '<table width="100%" border="0">';

        $hasil=mysql_query("select * from tbl_soalipa2 WHERE aktif='Y' ORDER BY RAND ()");
        ...
        while($row =mysql_fetch_array($hasil))
        {
            ...
            ?>
            <form name="form1" method="post" action="jawabipapaket2.php">
